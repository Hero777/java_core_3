...
import org.example.homework.four.mydz.ex1.*;
import org.example.homework.four.mydz.ex2.Duck;
import org.example.homework.four.mydz.ex2.Flyable;
import org.example.homework.four.mydz.ex2.Plane;
import org.example.homework.four.mydz.ex2.exceptions.FlyException;
import org.example.homework.four.mydz.ex3.*;
...
public class Homework4 {
    ...
    public static void ex1() {
        ...
        Car car1 = new Car(false, new Size(5, 2, 1.8));
        Car car2 = new Car(false, new Size(5, 2, 1.8));
        Car car3 = new Car(false, new Size(5, 2, 1.8));
        Car car4 = new Car(false, new Size(5, 2, 1.8));

        Bus bus1 = new Bus(false, new Size(12, 3, 2.3));
        Bus bus2 = new Bus(false, new Size(12, 3, 2.3));
        Bus bus3 = new Bus(false, new Size(12, 3, 2.3));
        Bus bus4 = new Bus(false, new Size(12, 3, 2.3));
        Bus bus5 = new Bus(false, new Size(12, 3, 2.3));

        Vehicle[] vehicles = {car1, car2, car3, car4, bus1, bus2, bus3, bus4, bus5};
        ...
        System.out.println("Стоимость мойки: " + carWash.getCost());
    }
    ...
    public static void ex2() {
        ...
        // Для утки:
        // Метод летать будет выкидывать ошибку FlyException (создать такой класс),
        // если утка подстрелена,
        ...
        //5. Создать 1 утку не раненую, 1 утку раненую, 1 самолет с 10 пассажирами,
        // 1 самолет с -1 пассажиром.
    ...
    public static void ex3() {
        ...
        SoundMaker man = new Man();
        man.sound();
        SoundMaker builder = new Builder();
        builder.sound();
        SoundMaker driver = new Driver();
        driver.sound();
